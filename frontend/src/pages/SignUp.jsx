...
import useLoginSubmit from "../utils/login/useLoginSubmit";
            ...
            <div className="w-full">
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <Label className="mt-6" check>
                  <Input type="checkbox" />
                  <span className="ml-2">
                    {"Iagree"} <span className="underline">{"privacyPolicy"}</span>
                  </span>
                </Label>
              ...
              >
                <ImFacebook className="w-4 h-4 mr-2" /> <span className="ml-2"> {"LoginWithFacebook"} </span>
              </button>
              <button
                disabled
                className="text-sm inline-flex items-center cursor-pointer transition ease-in-out duration-300 font-semibold font-serif text-center justify-center rounded-md focus:outline-none text-gray-700 bg-gray-100 shadow-sm my-2  md:px-2 lg:px-3 py-4 md:py-3.5 lg:py-4 hover:text-white hover:bg-red-500 h-11 md:h-12 w-full"
              >
                <ImGoogle className="w-4 h-4 mr-2" /> <span className="ml-2">{"LoginWithGoogle"}</span>
              </button>
